...
// DB_PATH bisa di-override lewat env var supaya file .db (dan file -wal/-shm pasangannya)
// bisa ditaruh di satu folder yang di-mount sebagai volume permanen (lihat docker-compose.yml
// / README bagian deploy Railway). Kalau tidak di-set, tetap jalan seperti biasa di folder ini.
const DB_PATH = process.env.DB_PATH || path.join(__dirname, 'nokayune.db');
